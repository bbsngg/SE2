...
public interface TicketService {
     ...
     * @return
     */
    //传过来的是ticketId列表和优惠券id
    ResponseVO completeTicket(List<Integer> id, int couponId,int cardId);
    ...
    /**
     * 完成购票【使用会员卡】流程包括会员卡扣费、校验优惠券和根据优惠活动赠送优惠券(这里的校验是看这个优惠券是否存在)
     * @param id
     * @param couponId
     * @return
     */
     ...
     * @return
     */
    ResponseVO getDetailsByTicketId(String idList);
